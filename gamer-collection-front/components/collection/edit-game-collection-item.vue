          ...
          <v-form ref="form" lazy-validation>
            <v-row dense>
              ...
              <v-col cols="12" sm="6" md="6">
                <v-text-field v-model="collectionItem.purchaseDate" label="Data da compra" outlined type="date"
                  :rules="[rules.maxDate, rules.minDate]"></v-text-field>
              </v-col>
              <v-col cols="12" sm="6" md="6">
                <v-text-field v-model="collectionItem.purchasePrice" :rules="[rules.minNumber]" outlined
                  label="Valor pago"></v-text-field>
              </v-col>
  ...
  methods: {
    async editConsole() {
      ...
      try {
        ...
        this.queueMessage('Jogo editado com sucesso')
        this.resetState()
      } catch (e) {
